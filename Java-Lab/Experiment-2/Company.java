...
public class Company {
    public static void main(String[] args) {
        ...
        Manager m    = new Manager("Bhumi Bhadre", "Ichalkaranji", 80000);
        Developer d  = new Developer("Bhumi Bhadre", "Ichalkaranji", 60000);
        Programmer p = new Programmer("Bhumi Bhadre", "Ichalkaranji", 50000);
